...
class UsuarioPrivadoDAO {
    ...
    static crearUsuario(correo, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existe = yield UserScheme_1.default.findOne(correo).exec();
            if (existe) {
                ...
                const objUsuario = new UserScheme_1.default(parametros);
    ...
    static obtenerUsuarios(res) {
        return __awaiter(this, void 0, void 0, function* () {
            UserScheme_1.default.find().sort({ _id: -1 }).populate("codProfile")
                .exec((miError, objeto) => {
                if (miError) {
    ...
    static obtenerUnUsuario(identificador, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            UserScheme_1.default.findOne(jsonUsuarioID).populate("codProfile")
                .exec((miError, objeto) => {
                if (miError) {
                    res.status(400).json({ respuesta: "Error en la consulta" });
                }
    ...
    static cantidadUsuariosEnPerfil(identificadorPerfil, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (mongoose_1.Types.ObjectId.isValid(identificadorPerfil)) {
                ...
                const cantidad = yield UserScheme_1.default.countDocuments({ codProfile: llave });
    ...
    static obtenerUsuariosPerfil(identificador, res) {
        return __awaiter(this, void 0, void 0, function* () {
            if (mongoose_1.Types.ObjectId.isValid(identificador)) {
                ...
                UserScheme_1.default.find({ codProfile: llave }).sort({ _id: -1 })
                    .populate({ path: "codProfile", select: "nombrePerfil" })
                    .exec((miError, objeto) => {
                    if (miError) {
                        console.log(miError);
                        res.status(400).json({ respuesta: "Error en la consulta" });
    ...
    static eliminarUsuario(identificador, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const existe = yield UserScheme_1.default.findById(identificador).exec();
            if (existe) {
                UserScheme_1.default.findByIdAndDelete(identificador, (miError, objeto) => {
    ...
    static actualizarUsuario(identificador, jsonExterno, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existe = yield UserScheme_1.default.findById(identificador).exec();
            if (existe) {
                UserScheme_1.default.findByIdAndUpdate({ _id: identificador }, { $set: jsonExterno }, (miError, objeto) => {
                    if (miError) {
                        console.log(miError);
