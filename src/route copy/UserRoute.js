...
class UserRoute {
    ...
    loadRoutes() {
        ...
        this.apiRouteUser.get("/all", UserController_1.default.queries);
        this.apiRouteUser.post("/create", UserController_1.default.create);
        // this.apiRouteUser.delete("/delete/:code", userController.delete);
        // this.apiRouteUser.put("/update/:code", userController.update);
    }
}
